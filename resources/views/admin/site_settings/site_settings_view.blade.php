    ...
    <main class="d-flex flex-nowrap">
        ...
        <div class="flex-shrink-0 p-3" style="width: 1400px;">
            <div class="col-10 offset-10">
                <a href="{{ route('events.store') }}" class="btn btn-primary">Add Events <svg
                    ...
                    <tbody>
                        @foreach ($events as $event)
                            <tr>
                                <td>{{ $event->id }}</td>
                                <td>
                                    <img src="{{ asset($event->image) }}" width="150px" height="100px"
                                        alt="{{ asset($event->image) }}">
                                </td>
                                ...
                                <td>
                                    <a href="{{ route('events.delete', $event->id) }}" class="btn btn-danger">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17"
