    ...
    <main class="d-flex flex-nowrap">
        ...
        <div class="flex-shrink-0 p-3" style="width: 1400px;">
            <div class="col-10 offset-10">
                <a href="{{ route('services.store') }}" class="btn btn-primary">Add Services <svg
                    ...
                    <tbody>
                        @foreach ($services as $service)
                            <tr>
                                <td>{{ $service->id }}</td>
                                <td>
                                    <img src="{{ asset($service->image) }}" width="150px" height="100px"
                                        alt="{{ asset($service->image) }}">
                                </td>
                                <td>{{ $service->title }}</td>
                                <td>{{ $service->about }}</td>
                                <td>{{ $service->in_detail }}</td>
                                <td>
                                ...
                                <td>
                                    <a href="{{ route('services.delete', $service->id) }}" class="btn btn-danger">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17"
