    ...
    <main class="d-flex flex-nowrap">
        ...
        <div class="flex-shrink-0 p-3" style="width: 1400px;">
            <div class="col-10 offset-10">
                <a href="{{ route('contact_us.store') }}" class="btn btn-primary">Add ContactUs <svg
                    ...
                    <tbody>
                        @foreach ($contact_us as $contact)
                            <tr>
                                ...
                                <td>{{ $contact->d_contact }}</td>
                                <td>
                                    <a href="{{ route('contact_us.edit', $contact->id) }}" class="btn btn-warning">
                                ...
                                <td>
                                    <a href="{{ route('contact_us.delete', $contact->id) }}" class="btn btn-danger">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17"
