    ...
    <main class="d-flex flex-nowrap">
        ...
        <div class="flex-shrink-0 p-3" style="width: 1400px;">
            <div class="col-10 offset-10">
                <a href="{{ route('about_us.store') }}" class="btn btn-primary">Add AboutUs <svg
                    ...
                    <tbody>
                        @foreach ($about_us as $about)
                            <tr>
                                <td>{{ $about->id }}</td>
                                <td>{{ $about->q_title }}</td>
                                <td>{{ $about->q_content }}</td>
                                <td>
                                    <a href="{{ route('about_us.edit', $about->id) }}" class="btn btn-warning">
                                ...
                                <td>
                                    <a href="{{ route('about_us.delete', $about->id) }}" class="btn btn-danger">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17"
