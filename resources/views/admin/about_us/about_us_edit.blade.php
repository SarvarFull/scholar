    ...
    <main class="d-flex flex-nowrap">
        ...
        <div class="flex-shrink-0 p-3" style="width: 1400px;">
            <div class="col-10 offset-10">
                <a href="{{ route('about_us.view') }}" class="btn btn-primary">Back to View
            ...
            <ul class="list-unstyled ps-0">
                <div class="col-9 p-3">
                    <form action="{{ route('about_us.update', $about_us->id) }}" method="POST"
                        ...
                        @csrf
                        <div class="mb-3">
                            <input type="text" name="q_title" value="{{ $about_us->q_title }}"
                                class="form-control @error('q_title') in-valid @enderror">
                            @error('q_title')
                        ...
                        <div class="mb-3">
                            <input type="text" name="q_content" value="{{ $about_us->q_content }}"
                                class="form-control @error('q_content') in-valid @enderror">
                            @error('q_content')
                                <div class="alert alert-danger alert-dismissible fade show mt-1" role="alert">
                                    {{ $message }}
                                    <button type="button" class="btn-close" data-bs-dismiss="alert"
