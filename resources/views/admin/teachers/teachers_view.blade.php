    ...
    <main class="d-flex flex-nowrap">
        ...
        <div class="flex-shrink-0 p-3" style="width: 1400px;">
            <div class="col-10 offset-10">
                <a href="{{ route('teachers.store') }}" class="btn btn-primary">Add Teachers <svg
                    ...
                    <tbody>
                        @foreach ($teachers as $teacher)
                            <tr>
                                <td>{{ $teacher->id }}</td>
                                <td>
                                    <img src="{{ asset($teacher->image) }}" width="150px" height="100px"
                                        alt="{{ asset($teacher->image) }}">
                                </td>
                                ...
                                <td>
                                    <a href="{{ route('teachers.delete', $teacher->id) }}" class="btn btn-danger">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17"
