...
<body>
    <main class="d-flex flex-nowrap">
        ...
        <div class="flex-shrink-0 p-3" style="width: 1400px; height: 5000px;">
            <div class="col-10 offset-10">
                <a href="{{ route('courses.store') }}" class="btn btn-primary">Add Courses <svg
                    ...
                    <tbody>
                        @foreach ($courses as $course)
                            <tr>
                                <td>{{ $course->id }}</td>
                                <td>
                                    <img src="{{ asset($course->image) }}" width="150px" height="100px"
                                        alt="{{ asset($course->image) }}">
                                </td>
                                ...
                                <td>
                                    <a href="{{ route('courses.delete', $course->id) }}" class="btn btn-danger">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17"
